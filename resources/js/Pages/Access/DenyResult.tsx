...
export default function DenyResult({ status, canReturn }: DenyResultProps) {
    ...
    return <AuthenticatedLayout title="Hasil pembatasan izin" hasCustomHeading><Head title="Hasil pembatasan izin" /><section className="max-w-2xl rounded-xl border border-border bg-surface p-6"><h1 role="status" className="text-lg font-semibold">{message}</h1>
