        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-100 via-white to-blue-50/50 flex flex-col justify-center items-center p-4 font-sans text-slate-800">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-6">
                    <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl border-2 border-secondary bg-primary text-white shadow-xl mb-3">
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    {demoUsers.map((u) => (
                                        <button
                                            ...
                                            className="text-left p-2 rounded-lg border border-border hover:border-primary hover:bg-primary/10 transition-all text-xs group cursor-pointer"
                                        >
                                            <div className="font-semibold text-ink capitalize group-hover:text-primary">
                                                {u.role}
                                            </div>
